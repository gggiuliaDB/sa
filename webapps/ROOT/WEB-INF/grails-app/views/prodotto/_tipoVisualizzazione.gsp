...
<div >
    <g:link controller="prodotto" action="${action}" params="[visualizzazione: 'grid2', q: q, linea: linea, tipoProdotto: tipoProdotto]"><span class="glyphicon glyphicon-th-large" aria-hidden="true"></span></g:link>   
	<g:link controller="prodotto" action="${action}" params="[visualizzazione: 'grid' , q: q, linea: linea, tipoProdotto: tipoProdotto]"><span class="glyphicon glyphicon-th" aria-hidden="true"></span></g:link> 
	<g:link controller="prodotto" action="${action}" params="[visualizzazione: 'list' , q: q, linea: linea, tipoProdotto: tipoProdotto]"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span></g:link>
