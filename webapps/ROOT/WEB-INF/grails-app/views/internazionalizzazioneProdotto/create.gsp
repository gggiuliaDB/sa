...
<html>
	...
	<body>
      <div class="container" >
		...
		<div id="create-internazionalizzazioneProdotto" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:internazionalizzazioneProdottoInstance, action:'save']" class="form-horizontal">
				<fieldset class="form">
