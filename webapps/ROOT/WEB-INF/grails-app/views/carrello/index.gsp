...
<html>
	...
	<body>
		<a href="#list-carrello" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-carrello" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${carrelloInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
