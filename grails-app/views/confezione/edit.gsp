...
<html>
	...
	<body>
		<a href="#edit-confezione" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-confezione" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:confezioneInstance, action:'update']" method="PUT" >
